                            ...
                            <div class="card-body p-4">
                                ...
                                <form action="{{ route('postLogin') }}" method="post">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control login" type="email" id="emailaddress" name="email"
                                            required="" placeholder="Enter your email">
                                    </div>

                                    <div class="form-group">
                                        <a href="forget-password.html" class="text-dark float-right"></a>
                                        <input class="form-control login" type="password" name="pwd" required=""
                                    ...
                                    {{-- <div class="form-group d-flex justify-content-between align-items-center mb-3">
                                        ...
                                        <span><a class="font-12 text-success" href="forget-password.html">Forgot your
                                                password?</a></span>
                                    </div> --}}
                                    ...
                                    {{-- <div class="text-center mt-15"><span class="mr-2 font-12">Don't have an
                                            account?</span><a class="font-12" href="register.html">Sign up</a>
                                    </div> --}}
